...
This repository contains an [interpreter](nn_interpreter/README.md), a [compiler for a meta-language with additional usability features](nnce_compiler/README.md), and a variety of [examples](examples/README.md).
